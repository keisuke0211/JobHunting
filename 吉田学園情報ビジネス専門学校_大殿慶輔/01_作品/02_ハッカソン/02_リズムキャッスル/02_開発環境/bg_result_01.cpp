...
// プロトタイプ宣言
//****************************************
// BG:リザルト[01] のパラメーター初期化処理
void InitParameterBg_result_01(Bg_result_01Parts *pParts);

//****************************************
// グローバル宣言
//****************************************
LPDIRECT3DTEXTURE9		g_aTextureBg_result_01	// テクスチャへのポインタ
						[BG_RESULT_01_PARTS_MAX]
						= {};
LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffBg_result_01	// 頂点バッファへのポインタ
						= NULL;
Bg_result_01Control		g_bg_result_01Control;	// BG:リザルト[01] の管理情報
Bg_result_01Parts		g_aBg_result_01Parts		// BG:リザルト[01] の部品毎の情報
						[BG_RESULT_01_PARTS_MAX];
...
//========================================
// InitParameterBg_result_01関数 - BG:リザルト[01] のパラメーター初期化処理 -
// Author:RIKU NISHIMURA
//========================================
void InitParameterBg_result_01(Bg_result_01Parts *pParts)
{
...
//========================================
// LoadBg_result_01関数 - BG:リザルト[01] の読み込み処理 -
// Author:RIKU NISHIMURA
//========================================
void LoadBg_result_01(void) 
{
	...
	char				aDataSearch	// データ検索用
						[TXT_MAX];
	Bg_result_01Control	*pCtl		// BG:リザルト[01] の管理情報のポインタ
						= &g_bg_result_01Control;
	Bg_result_01Parts	*pParts		// BG:リザルト[01] の部品毎の情報のポインタ
...
//========================================
// InitBg_result_01関数 - BG:リザルト[01] の初期化処理 -
// Author:RIKU NISHIMURA
//========================================
...
//========================================
// UninitBg_result_01関数 - BG:リザルト[01] の終了処理 -
// Author:RIKU NISHIMURA
//========================================
...
//========================================
// UpdateBg_result_01関数 - BG:リザルト[01] の更新処理 -
// Author:RIKU NISHIMURA
//========================================
...
//========================================
// DrawBg_result_01関数 - BG:リザルト[01] の描画処理 -
// Author:RIKU NISHIMURA
//========================================
